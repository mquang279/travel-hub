...
public class TravelPlaceController {
    ...
    public ResponseEntity<Void> deleteReview(@PathVariable Long placeId) {
        this.travelPlaceService.deleteReview(placeId, this.currentUserProvider.getCurrentUserId());
